...
TOKENIZED_TEXT_FILES_PATH = "/home/usuaris/veu/ksenia.kharitonova/tfm/data/mt/attn-analysis/en-ru/f-syn-lemmas"
#BPE_TEXT_FILES_PATH = os.path.join('..','..','..','..','data','iwslt14-preprocessed-joined')
BPE_TEXT_FILES_PATH = "/home/usuaris/veu/ksenia.kharitonova/tfm/data/mt/attn-analysis/en-ru/f-syn-lemmas"
...
def main():
    for dataset in ['mt']:
        ...
        POS_path = os.path.join(TOKENIZED_TEXT_FILES_PATH, dataset + '.' + LANG + '_lemmasS')
