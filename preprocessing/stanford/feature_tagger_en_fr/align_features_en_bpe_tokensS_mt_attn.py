...
PATH = "/home/usuaris/veu/ksenia.kharitonova/tfm/data/mt/attn-analysis/de-en/f-pos"
PATH_POS = "/home/usuaris/veu/ksenia.kharitonova/tfm/data/mt/attn-analysis/de-en/f-pos"
PATH_TAGS = "/home/usuaris/veu/ksenia.kharitonova/tfm/data/mt/attn-analysis/de-en/f-tags"
PATH_DEPS = "/home/usuaris/veu/ksenia.kharitonova/tfm/data/mt/attn-analysis/de-en/f-deps"
PATH_LEMMAS = "/home/usuaris/veu/ksenia.kharitonova/tfm/data/mt/attn-analysis/de-en/f-lemmas"
...
def main():
    for dataset in ['mt']:
        ...
        with open(os.path.join(PATH, dataset + '.' + LANG + '_tags'), 'r') as file:
            text_tag = file.read()
        '''
        with open(os.path.join(PATH_LEMMAS, dataset + '.' + LANG + '_lemmasS'), 'r') as file:
            text_lemma = file.read()
        with open(os.path.join(PATH_POS, dataset + '.' + LANG + '_posS'), 'r') as file:
            text_pos = file.read()
        with open(os.path.join(PATH_DEPS, dataset + '.' + LANG + '_depsS'), 'r') as file:
            text_dep = file.read()
        with open(os.path.join(PATH_TAGS, dataset + '.' + LANG + '_tagsS'), 'r') as file:
            text_tag = file.read()
        ...
        with open(os.path.join(PATH_LEMMAS, dataset + '.bpe.' + LANG + '_lemmas'), 'w') as file:
            file.write(repeated_lemmas)
        with open(os.path.join(PATH_POS, dataset + '.bpe.' + LANG + '_pos'), 'w') as file:
            file.write(repeated_pos)
        with open(os.path.join(PATH_DEPS, dataset + '.bpe.' + LANG + '_deps'), 'w') as file:
            file.write(repeated_deps)
        with open(os.path.join(PATH_TAGS, dataset + '.bpe.' + LANG + '_tags'), 'w') as file:
