...
#SBATCH --ignore-pbs
#SBATCH --output=/home/usuaris/veu/ksenia.kharitonova/tfm/log/preprocess-joined-bpe-mt-ru.log

WORKING_DIR="/home/usuaris/veu/ksenia.kharitonova/tfm/data/mt/en-ru/"
SRC="en_tokensS"
TGT="ru_tokensS"
...
stdbuf -i0 -e0 -o0  $PYTHON $FAIRSEQ_DIR/preprocess.py --source-lang $SRC --target-lang $TGT \
       --testpref $WORKING_DIR/mt.bpe --destdir $WORKING_DIR --srcdict $DEST_DIR2/dict.en_tokensS.txt --tgtdict $DEST_DIR2/dict.ru_tokensS.txt --nwordstgt $N_OP --nwordssrc $N_OP
