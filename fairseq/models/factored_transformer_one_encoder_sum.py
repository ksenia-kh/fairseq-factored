...
@register_model('factored_transformer_one_encoder_sum')
class FactoredTransformerOneEncoderSumModel(FairseqFactoredOneEncoderModel):
    """
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        for lang in self.srcs:
            if x is None:
                ...
                x = torch.add(x, getattr(self, 'embed_' + lang)(src_tokens[i]))
            i += 1
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum')
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_iwslt_de_en_babelnet')
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_iwslt_de_en_lemmas')
def factored_one_encoder_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 1024)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_embed_dim_sizes = {'de': 512, 'de_lemmas10k': 512}
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 1024)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 4)
    args.decoder_layers = getattr(args, 'decoder_layers', 6)
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_iwslt_de_en_lemmas_stanford')
def factored_one_encoder_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 1024)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_iwslt_de_en_lemmas_stanfordS')
def factored_one_encoder_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 1024)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_embed_dim_sizes = {'de_tokensS': 512, 'de_tokensS_lemmas': 512}
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 1024)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 4)
    args.decoder_layers = getattr(args, 'decoder_layers', 6)
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_en_ne_lemmas')
def factored_one_encoder_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 2)
    args.encoder_layers = getattr(args, 'encoder_layers', 5)
    args.encoder_embed_dim_sizes = {'en': 512, 'en_lemmas': 512}
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
...
# French WMT architecture

@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_wmt_en_fr_posS')
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_wmt_en_fr_tags')
def transformer_wmt_en_fr(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
    args.encoder_embed_dim_sizes = {'en_tokensS': 512, 'en_tags': 512}
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 2048)
    args.decoder_layers = getattr(args, 'decoder_layers', 6)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_wmt_en_fr_deps')
def transformer_wmt_en_fr(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
    args.encoder_embed_dim_sizes = {'en_tokensS': 512, 'en_deps': 512}
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 2048)
    args.decoder_layers = getattr(args, 'decoder_layers', 6)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_wmt_en_fr_lemmas')
def transformer_wmt_en_fr(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
    args.encoder_embed_dim_sizes = {'en_tokensS': 512, 'en_lemmas': 512}
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 2048)
    args.decoder_layers = getattr(args, 'decoder_layers', 6)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
...
@register_model_architecture('factored_transformer_one_encoder_sum', 'factored_transformer_one_encoder_sum_wmt_en_fr_synsets')
def transformer_wmt_en_fr(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
    args.encoder_embed_dim_sizes = {'en_tokensS': 512, 'en_synsets_wo_at_lemmas': 512}
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_ffn_embed_dim = getattr(args, 'decoder_ffn_embed_dim', 2048)
    args.decoder_layers = getattr(args, 'decoder_layers', 6)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 8)
