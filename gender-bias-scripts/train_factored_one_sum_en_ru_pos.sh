...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/ksenia.kharitonova/tfm/log/train-factored-wmt-one-sum-en-ru-pos.log
...
stdbuf -i0 -e0 -o0 $PYTHON $FAIRSEQ_DIR/train.py $WORKING_DIR \
 ...
 --criterion label_smoothed_cross_entropy --label-smoothing 0.1 --max-tokens 4096 \
  --save-dir $CP_DIR --lang-pairs en_tokensS-ru_tokensS,en_pos-ru_tokensS --max-update 160000 \
