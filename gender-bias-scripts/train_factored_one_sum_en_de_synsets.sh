...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/ksenia.kharitonova/tfm/log/train-factored-wmt-one-sum-en-de-synsets-retrain.log
...
stdbuf -i0 -e0 -o0 $PYTHON $FAIRSEQ_DIR/train.py $WORKING_DIR \
 ...
 --criterion label_smoothed_cross_entropy --label-smoothing 0.1 --max-tokens 4096 \
  --save-dir $CP_DIR --lang-pairs en_tokensS-de_tokensS,en_synsets_wo_at_lemmas-de_tokensS \
