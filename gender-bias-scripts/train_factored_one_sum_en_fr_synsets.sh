...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/ksenia.kharitonova/tfm/log/train-factored-wmt-one-sum-en-fr-synsets-new-retrain.log
...
stdbuf -i0 -e0 -o0 $PYTHON $FAIRSEQ_DIR/train.py $WORKING_DIR \
 --task factored_translation --arch factored_transformer_one_encoder_sum_wmt_en_fr_synsets \
 ...
 --max-tokens 4096  --save-dir $CP_DIR --lang-pairs en_tokensS-fr_tokensS,en_synsets_wo_at_lemmas-fr_tokensS \
