...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/ksenia.kharitonova/tfm/log/train-factored-wmt-one-sum-en-es-synsets-retrain.log
...
stdbuf -i0 -e0 -o0 $PYTHON $FAIRSEQ_DIR/train.py $WORKING_DIR \
 ...
 --criterion label_smoothed_cross_entropy --label-smoothing 0.1 --max-tokens 4000 \
  --save-dir $CP_DIR --lang-pairs en_tokensS-es_tokensS,en_synsets_wo_at_lemmas-es_tokensS \
